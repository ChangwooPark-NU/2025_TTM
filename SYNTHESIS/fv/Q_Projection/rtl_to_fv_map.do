...
# Generated on: Sat Dec 06 19:40:49 CST 2025 (Sun Dec 07 01:40:49 UTC 2025)
...
set logfile fv/Q_Projection/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/Q_Projection -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/vlsi/tools/cadence/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/vlsi/tools/cadence/GENUS211/tools.lnx86"
set env(CW_DIR) "/vlsi/tools/cadence/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/vlsi/tools/cadence/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /vlsi/tools/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/vlsi/tools/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/vlsi/tools/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/vlsi/tools/cadence/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/vlsi/tools/cadence/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
elaborate_design -golden -root {Q_Projection} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Q_Projection/fv_map.v.gz
elaborate_design -revised -root {Q_Projection}
...
#add_name_alias fv/Q_Projection/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.Q_Projection.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.Q_Projection.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.Q_Projection.rtl.fv_map.rpt
